...
united <- read.csv("Sources/United/United_before2000.csv")
united <- data.frame(
...
migrantsfile <- read.csv("Sources/United/United_before2000.csv")
...
source("Sources/IOM/download.R") # download
iom <- read.csv("Sources/IOM/Missing_Migrants_Global_Figures_allData.csv")
...
categories <- list(
  ...
  list(
    ...
    en = "Suicide",
    color = "#F8E91F",
    texts = c("Suicide", "suicide - hanged", "suicide", "suicide - put on fire",
  ...
  list(
    ...
    color = "#1C7532",
    texts = c("Mort de faim, de soif ou de froid", "starved", "frozen", "exhaustion",
  ...
  list(
    ...
    color = "#F49919",
    texts = c("Incendie criminel, homicide, absence de soins", "tortured", "executed", "Violence",
  ...
  list(
    ...
    color = "#637A84",
    texts = c("Empoisonnement", "Empoisonnement, champ de mise, accident, autre", "unknown",
